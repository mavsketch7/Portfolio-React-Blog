...
export const projectsdata: Projectdata[] = [
  {
    ...
    gallery: [],
    description:
      'El proyecto consistió en el desarrollo de la web corporativa de **MRS Inmobiliaria Córdoba** para mejorar su presencia online mediante un **sistema de citas**.\n\nSe utilizó **WordPress y Elementor** para lograr un diseño minimalista y autogestionable, enfocado en la velocidad y la experiencia de usuario.\n\nA pesar de ser una **landing page** con contenido reducido, se optimizó el **SEO local** incluyendo FAQs y trabajando su perfil de **Google Business**.\n\nEl proyecto incluyó **seguimiento y asesoramiento guiado**, logrando posicionar el perfil de Google en primera posición para "inversión inmobiliaria Córdoba", superando a la competencia.\n\nEl resultado final fue una web alineada con la marca, correctamente indexada y un cliente satisfecho.',
    funFact:
